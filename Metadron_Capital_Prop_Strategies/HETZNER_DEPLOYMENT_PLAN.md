...
| **Network** | OpenBB API calls, IBKR broker API, FRED, SEC, real-time data feeds |
...
4. Configure `.env` with API keys (OpenBB, IBKR, FRED)
...
1. Switch broker from paper to IBKR
